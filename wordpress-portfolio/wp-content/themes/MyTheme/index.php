...
<section id="about" class="s_about bg_light">
  <div class="section_header">
    <h2><?php
      ...
      ?></h2>
      <div class="s_description_wrap">
        <div class="s_description"><?php
      ...
      <div class="row">
        <div class="filter_div controls">
          <ul>
            ...
            <li class="filter" data-filter=".identy">E-mail открытки</li>
        ...
        <div id="portfolio_grid">
          ...
          <div class=" mix col-md-3 col-sm-6 col-xs-6 portfolio_item <?php $tags = wp_get_post_tags($post->ID); if ($tags) {foreach($tags as $tag) {echo ' ' . $tag->name;}} ?>">
        ...
        <div class="col-md-6 col-sm-6 ">
          <div class="contact_box">
            ...
            <div class="contact_box">
              ...
              <div class="col-md-6 col-sm-6 ">
                <form action="http://formspree.io/dimka.borec@gmail.com" class="main_form" novalidate target="_blank" method="post">
                  ...
                  <label class="form-group">
                    ...
                    <input type="email" name="email" placeholder="Ваше E-mail" data-validation-required-message="Не корректно введен E-mail" required />
                    <span class="help-block text-danger"></span>
                  </label>
                  <label class="form-group">
                    <span class="color_element">*</span>Ваше Сообщение:
                    <textarea name="massage" placeholder="Ваше Сообщение" data-validation-required-message="Вы не ввели собщение" required ></textarea>
                    <span class="help-block text-danger"></span>
                  </label>
